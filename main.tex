...
QA task focuses on automatically understand natural language questions and select or generate a answer (or more) which can match semantically the question. %In the English QA system based on document, many efforts have been made to achieve a continually  better performance. 
...
The competition have provided four baseline as follow:%: \emph{Average Word Embeding}, \emph{Machine Translation} \emph{Paraphrase}, \emph{Word Overlap}. 
\begin{table}[!hbp]
